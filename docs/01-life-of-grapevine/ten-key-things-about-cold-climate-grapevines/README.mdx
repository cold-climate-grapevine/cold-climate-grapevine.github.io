...
import SingleImageZoom from "@site/src/components/SingleImageZoom";
...
<SingleImageZoom img={require("./grapevines-can-pollinate-themselves.png")} />
...
![Berries Use Sunlight, Nutrients, And Water to Grow and Ripen](berries-use-sunlight-nutrients-and-water-to-grow-and-ripen.png)
...
![Fruit Ripening Requires the Plant to Move Sugars & Nutrients from Leaves to Fruit](fruit-ripening-requires-the-plant-to-move-sugars--nutrients-from-leaves-to-fruit.png)
...
![Berries Need Plenty of Leaves to Ripen, But Too Many Can Shade Them](berries-need-plenty-of-leaves-to-ripen-but-too-many-can-shade-them-1.png)
...
![Grapevines Rely on Us to Produce High Quality Fruit](grapevines-rely-on-us-to-produce-high-quality-fruit.png)
...
![Dormant Pruning](dormant-pruning.png)
...
![Shoot Thinning](shoot-thinning.png)
...
![Diseases Attack Grapevines Early in the Season](diseases-attack-grapevines-early-in-the-season.png)
...
![Grapevines Put Out New "Suckers" from the Ground Each Year](grapevines-put-out-new-suckers-from-the-ground-each-year.png)
...
![They Get Cold](they-get-cold.png)
