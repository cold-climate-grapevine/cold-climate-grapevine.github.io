    ...
    case initial:
      if (onLine) {
        ...
        return userTriggered || !shouldAutoDownload
          ? _constants.icons.load
          : _constants.icons.noicon;
      } else {
  ...
  (function (_Component) {
    ...
    function IdealImage(props) {
      ...
      _defineProperty(
        ...
        "load",
        function (userTriggered) {
          var _this$state2 = _this.state,
            loadState = _this$state2.loadState,
            url = _this$state2.url;
          if (_helpers.ssr || loaded === loadState || loading === loadState)
            return;
          ...
          var loader =
            _this.props.loader === "xhr"
              ? (0, _loaders.xhrLoader)(url)
              : (0, _loaders.imageLoader)(url);
          loader
            .then(function () {
              _this.clear();
      ...
      _defineProperty(_assertThisInitialized(_this), "onEnter", function () {
        ...
        var pickedSrc = (0, _helpers.selectSrc)({
          ...
          maxImageWidth:
            _this.props.srcSet.length > 1
              ? (0, _helpers.guessMaxImageWidth)(_this.state.dimensions) // eslint-disable-line react/no-access-state-in-setstate
              : 0,
        ...
        var shouldAutoDownload = _this.props.shouldAutoDownload(
    ...
    _proto.loadStateChange = function loadStateChange(
      loadState,
      userTriggered,
      loadInfo
    ) {
    ...
    _proto.render = function render() {
      ...
      return _react.default.createElement(
        ...
        _react.default.createElement(
          _Media.default,
          _extends({}, this.props, (0, _helpers.fallbackParams)(this.props), {
...
_defineProperty(IdealImage, "propTypes", {
  ...
  /** array of sources */
  srcSet: _propTypes.default.arrayOf(
